...
pnpm run dev
\`\`\`
`;const ke=async n=>{const e=["devui.js","import-map.json"],{default:t}=await P(()=>import("./jszip.min.e44410ec.js").then(function(a){return a.j}),["assets/jszip.min.e44410ec.js","assets/vendor.cbd434a5.js"]),s=new t;s.file("index.html",_e),s.file("package.json",Ie),s.file("vite.config.js",be),s.file("README.md",je);const i=s.folder("src");i==null||i.file("main.js",ye);const o=n.getFiles();for(const a in o){if(e.includes(a))continue;let l=o[a];a==="App.vue"&&(l=l.replace(`import { setupDevui } from './devui.js'
`,"").replace(`// don't remove
`,"").replace(`setupDevui()
`,"")),i==null||i.file(a,l)}const r=await s.generateAsync({type:"blob"});K.exports.saveAs(r,"vue-devui-starter.zip")},De={class:"flex justify-between p-2"},we=S("h1",{class:"text-base"}," DevUI Playground ",-1),xe=y(" Download "),Se=y(" Share "),Ve=y(" GitHub "),Ce=E({props:{store:null},setup(n){const e=n,{success:t,warning:s}=W(),i=async()=>{if(!navigator.clipboard){s("navigator.clipboard is undefined");return}await navigator.clipboard.writeText(location.href),t("Current URL has been copied to clipboard.")},o=L({Vue:{name:"Vue",vers:fe(),activeVer:e.store.versions.Vue,isLoading:!1},DevUI:{name:"DevUI",vers:me(),activeVer:e.store.versions.DevUI,isLoading:!1}}),r=async(a,l)=>{o[a].isLoading=!0,await e.store.setVersion(a,l),o[a].isLoading=!1};return(a,l)=>{const T=X,B=Y,V=Q,z=$,D=ee;return f(),x("div",De,[we,d(V,null,{default:c(()=>[(f(!0),x(A,null,N(g(o),u=>(f(),I(z,{key:u.name,spinning:u.isLoading},{default:c(()=>[d(V,null,{default:c(()=>[y(te(u.name)+": ",1),d(B,{value:u.activeVer,"onUpdate:value":[v=>u.activeVer=v,v=>r(u.name,v)],class:"min-w-32",searchable:!0},{default:c(()=>[(f(!0),x(A,null,N(u.vers,v=>(f(),I(T,{key:v,label:v,value:v},null,8,["label","value"]))),128))]),_:2},1032,["value","onUpdate:value"])]),_:2},1024)]),_:2},1032,["spinning"]))),128)),d(D,{onClick:l[0]||(l[0]=u=>g(ke)(n.store))},{default:c(()=>[xe]),_:1}),d(D,{mode:"text",onClick:i},{default:c(()=>[Se]),_:1}),d(D,{mode:"link",href:"https://github.com/brenner8023/devui-playground",target:"_blank",rel:"noopener noreferrer"},{default:c(()=>[Ve]),_:1})]),_:1})])}}}),k="devui.js",Oe=`
