...
`,"").replace(`setupDevui()
`,"")),i==null||i.file(a,l)}const r=await s.generateAsync({type:"blob"});K.exports.saveAs(r,"vue-devui-starter.zip")},ke={class:"flex justify-between p-2"},we=w("h1",{class:"text-base"}," DevUI Playground ",-1),xe=y(" Download "),Se=y(" Share "),Ve=y(" GitHub "),Ce=E({props:{store:null},setup(n){const e=n,{success:t,warning:s}=W(),i=async()=>{if(!navigator.clipboard){s("navigator.clipboard is undefined");return}await navigator.clipboard.writeText(location.href),t("Current URL has been copied to clipboard.")},o=L({Vue:{name:"Vue",vers:fe(),activeVer:e.store.versions.Vue,isLoading:!1},DevUI:{name:"DevUI",vers:me(),activeVer:e.store.versions.DevUI,isLoading:!1}}),r=async(a,l)=>{o[a].isLoading=!0,await e.store.setVersion(a,l),o[a].isLoading=!1};return(a,l)=>{const T=X,B=Y,V=Q,z=N,j=ee;return f(),k("div",ke,[we,d(V,null,{default:c(()=>[(f(!0),k(A,null,$(g(o),u=>(f(),I(z,{key:u.name,spinning:u.isLoading},{default:c(()=>[d(V,null,{default:c(()=>[y(te(u.name)+": ",1),d(B,{value:u.activeVer,"onUpdate:value":[v=>u.activeVer=v,v=>r(u.name,v)],class:"min-w-32",searchable:!0},{default:c(()=>[(f(!0),k(A,null,$(u.vers,v=>(f(),I(T,{key:v,label:v,value:v},null,8,["label","value"]))),128))]),_:2},1032,["value","onUpdate:value"])]),_:2},1024)]),_:2},1032,["spinning"]))),128)),d(j,{onClick:l[0]||(l[0]=u=>g(De)(n.store))},{default:c(()=>[xe]),_:1}),d(j,{mode:"text",onClick:i},{default:c(()=>[Se]),_:1}),d(j,{mode:"link",href:"https://github.com/brenner8023/devui-playground",target:"_blank",rel:"noopener noreferrer"},{default:c(()=>[Ve]),_:1})]),_:1})])}}}),S="devui.js",Oe=`
...
const loadCss = () => {
  ...
  link.rel = 'stylesheet'
  link.href = '${b("vue-devui","1.0.0-rc.1","/style.css")}'
